                    ...
                    if( graphs[key] == 0 ) {
                        ...
                        */
                        ...
                        if (data[0] != "Dados para criação do gráfico não encontrado") {
                            ...
                            */
                            $('#'+key).empty();
                            graphs[key] = Plotly.plot(key, data, createLayout(key, 'Average Bandwidth (Bps)'),{responsive: true});
                        } else {
                            /*
                    ...
                    */
                    if( graphs[key] == 0 ) {
                        ...
                        if ( data[0] != "Dados para criação do gráfico não encontrado" ) {
                            ...
                            */
                           $('#'+key).empty();
                            graphs[key] = Plotly.plot(key, data, createLayout(key),{responsive: true});
                        } else {
                            /*
                            * Adiciona mensagem caso não seja encontrado dados
                            */
